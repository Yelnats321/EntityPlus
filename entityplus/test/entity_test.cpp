...
TEST_CASE("components", "[entity]") {
    ...
    em.for_each<A>([](auto, auto) { REQUIRE(false); });
    em.for_each<A, B>([](auto, auto, auto) { REQUIRE(false); });
...
TEST_CASE("get_entities", "[entity]") {
    SECTION("by type") {
        ...
        };
        {
            ...
            REQUIRE((isInAll(ent1) && isInAll(ent2) && isInAll(ent3) && isInAll(ent4) &&
                     isInAll(ent5)));
        }
        {
...
TEST_CASE("for_each entity", "[entity]") {
    ...
    em.for_each<A, B, TA>([&](auto, auto&, auto&) { REQUIRE(false); });
}
...
TEST_CASE("entity metafunction", "[entity]") {
    ...
    // em.for_each<int>([]() {});
    // em.for_each<tag, int>([](auto, auto, auto) {});
